...
debug_all:
	cmake -B build_debug -D CMAKE_BUILD_TYPE=Debug -G Ninja && cmake --build buildi_debug/
thread_all:
	cmake -B build_thread -D CMAKE_BUILD_TYPE=THREAD -G Ninja && cmake --build build_thread/
